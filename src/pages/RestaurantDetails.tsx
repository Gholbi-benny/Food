        ...
        <div className="mt-6">
          ...
          <div className="space-y-3">
            {restaurant.menu.map((food) => (
              <div
                key={food.id}
                className="bg-gray-800 rounded-xl p-5 flex justify-between items-center hover:bg-gray-800/80 hover:border-orange-500/30 border border-transparent transition-colors"
              >
