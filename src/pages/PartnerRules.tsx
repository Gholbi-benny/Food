      ...
      <div className="max-w-3xl mx-auto text-gray-900 dark:text-white">
        ...
        <div className="space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              L'accès à l'espace de gestion (identifiants de connexion) est
              personnel et confidentiel. Le restaurant est responsable de la
              confidentialité de ses identifiants et des modifications
